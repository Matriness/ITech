...
function text(){
  ...
  //alert(variable);
    ajax.open("GET","../laBognad2.loc/php/league.php?league=" + variable);
...
function xhr(){
    ...
    ajax.open("POST","../laBognad2.loc/php/ajax_date.php");
...
function xmlhr(){
    ...
    //alert(select);
    ajax.open("POST","../laBognad2.loc/php/select_game_name_xml.php");
    ajax.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
